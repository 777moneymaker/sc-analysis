...
# Sensational dimensions reduction
...
# Biology = f, kse = 3 (biology: dont add anything else besides clusters, kse: number of clusters)
sce.clus = sc3(sce, ks = 3, biology = F, n_cores = 4)
sce.clus
```
